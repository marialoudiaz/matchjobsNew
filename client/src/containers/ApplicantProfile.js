...
function ApplicantProfile() {
  ...
  <>
{/* // Si aucun sheet n'est affiché
  // afficher  */}

  {const userName = await axios.get(`${URL}/applicant/getUserName/${id}`)
    <h1>Hello {userName},</h1>
    <h2>you don't have any application created yet</h2>

    <div>
      <p>all your applications</p>
    </div>
